...
ASSIGNMENT 01
Submitted by: S M Rafiuddin (A20387294)

FILES INCLUDED:

A1A.CPP
THE MAIN C SOURCE FILE CONTAINING THE SIMULATOR.
DFSM.TXT
INPUT FILE CONTAINING THE DFSM SPECIFICATION.
INPUT.TXT
INPUT FILE CONTAINING THE STRING TO BE PROCESSED BY THE DFSM.

HOW TO RUN THE CODE:

>>gcc -o ASSIGNMENT01.C
>>./ASSIGNMENT01 DFSM.txt INPUT.txt
